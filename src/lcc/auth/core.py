...
# Configuration
SECRET_KEY = os.getenv("LCC_SECRET_KEY", "your-secret-key-change-this-in-production")
ALGORITHM = "HS256"
...
def authenticate_user(username: str, password: str, user_repository=None) -> Optional[User]:
    """
