...
from lcc.sbom import CycloneDXGenerator, SBOMSigner, SBOMValidator, SPDXGenerator
...
def verify(sbom_file: Path, signature: Path | None, gpg_home: Path | None):
    """Verify an SBOM signature."""
    try:
        console.print("[cyan]Verifying SBOM signature...[/cyan]")
...
def list_keys(gpg_home: Path | None):
