...
def get_ai_license_info(license_id: str) -> AILicenseInfo | None:
    """
...
def normalize_ai_license_name(name: str) -> str | None:
    """
...
def has_user_threshold(license_id: str) -> str | None:
    """
