...
def _match_reason(license_id: str, reasons: dict[str, str]) -> str | None:
...
def _resolve_context_explanation(context_data: dict[str, object]) -> str | None:
