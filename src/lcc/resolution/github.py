...
class GitHubResolver(Resolver):
    ...
    def _fetch_license(self, owner: str, repo: str) -> Optional[dict]:
    ...
    def _extract_repository(self, component: Component) -> Optional[Tuple[str, str]]:
        candidates = []
    ...
    def _parse_repo(self, value: str) -> Optional[Tuple[str, str]]:
        value = value.strip()
        if not value:
            return None
