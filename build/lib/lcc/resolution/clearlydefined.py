...
class ClearlyDefinedResolver(Resolver):
    ...
    def _fetch_definition(self, coordinate: str) -> Optional[dict]:
    ...
    def _build_coordinate(self, component: Component) -> Optional[str]:
    ...
    def _type_mapping(self, component: Component) -> Optional[Tuple[str, str]]:
    ...
    def _extract_license_expression(self, data: dict) -> Optional[str]:
    ...
    def _extract_source_url(self, data: dict) -> Optional[str]:
